...
<body>
	...
	<script src="https://cdn.tiny.cloud/1/<?php echo TINYMCE_API_KEY; ?>/tinymce/8/tinymce.min.js" referrerpolicy="origin" crossorigin="anonymous"></script>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$.ajax({
				type: 'POST',
				url: '../../API/Admin/getAllOrderData.php',
				dataType: 'json',
					...
					if (data.length > 0) {
						...
						$.each(data, function(index, row) {
							...
							table.row.add([
								...
								statusBadge,
								row.Order_Date,
								'<div class="actions"><a class="btn btn-sm bg-success-light" href="view_order.php?Order_Id=' + row.Order_Id + '"><i class="fe fe-eye"></i> View </a></div>'
							]);
						});
